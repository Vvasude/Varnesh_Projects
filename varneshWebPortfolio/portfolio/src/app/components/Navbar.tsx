...
const Navbar: React.FC = () => {
    ...
    return (
        <header className={`fixed w-full bg-transparent z-50 h-auto transition-all ${scrolling ? 'blur-background' : ''} ${mobileMenuOpen ? 'h-24 blur-background' : ''} border-b-2 border-black`}>
            <nav className="container mx-auto px-6 py-3 flex justify-between items-center">
                ...
                <div className="flex space-x-4">
                    ...
                    <Link href="https://github.com/Vvasude/Varnesh_Projects" target='_blank' className="hidden md:flex">
                        <FaGithub size={36} />
                    </Link>
                    <Link href="https://www.linkedin.com/in/varneshvasudevan/" target='_blank' className="hidden md:flex">
                        <FaLinkedin size={36} />
                    </Link>
                </div>
            </nav>
